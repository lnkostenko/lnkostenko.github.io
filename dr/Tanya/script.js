// Crossword data
const crosswordData = {
    width: 17, //ШИРИНА СЕТКИ
    height: 15, //ВЫСОТА СЕТКИ
    words: [ //МАССИВ СЛОВ, МОЖНО ДОБАВИТЬ ПО ШАБЛОНУ
        ...
        },
        {
            ...
            length: 9,
            answer: 'ГРОБОВЩИК',
            clue: 'Профессия мальчика с тыквой на голове из «Ангела кровопролития"?',
            cells: []
        },
        {
            id: 'word3',
            ...
            length: 6,
            answer: 'ФЛЕЙТА',
            clue: 'С помощью какого предмета Алладин из «Маги: лабиринт магии» призывает джина?',
            cells: []
        },
        {
            id: 'word4',
            ...
            length: 5,
            answer: 'ГУНГИ',
            clue: 'Вымышленная настольная игра из аниме «Охотник х охотник»?',
            cells: []
        },
        {
            id: 'word5',
            ...
            length: 5,
            answer: 'ТЕНЬЮ',
            clue: 'Чем себя называет Тэцуя Куроко?',
            cells: []
        },
        {
            id: 'word6',
            ...
            length: 7,
            answer: 'ВОДОЛЕЯ',
            clue: 'Чьим ключом жертвует Люси из Хвоста феи?',
            cells: []
        },
        {
            id: 'word7',
            ...
            length: 6,
            answer: 'ЧЕТЫРЕ',
            clue: 'Сколько яиц имеет главная «Чара-хранителей!»?',
            cells: []
        },
        {
            id: 'word8',
            ...
            length: 9,
            answer: 'АГНАПОЛИС',
            clue: 'Принцем какой страны является Сесиль Айдзима?',
            cells: []
        },
        {
            id: 'word9',
            ...
            length: 7,
            answer: 'ЗЕЛЁНЫЙ',
            clue: 'Какой дракон из «Йоны на заре» может высоко прыгать?',
            cells: []
        },
        {
            id: 'word10',
            ...
            length: 6,
            answer: 'СТРАЙД',
            clue: 'Экстремальный вид спорта, правила которого максимально просты: шесть игроков из одной команды должны передавать эстафету друг другу из города в город?',
            cells: []
        },
        {
            id: 'word11',
            ...
            length: 6,
            answer: 'НАГИСА',
            clue: 'Какой персонаж с  маленьким ростом и отсутствием физических способностей, сравним с возможностями девочки?',
            cells: []
        },
        {
            id: 'word12',
            ...
            length: 4,
            answer: 'ТРОЕ',
            clue: 'Сколько детей выжило когда сожгли деревню в Хаккэндэн?',
            cells: []
        },
        {
            id: 'word13',
        ...
        },
        {
            ...
            length: 9,
            answer: 'КЕРОБЕРОС',
            clue: 'Кто уснув на 30 лет на своём посту, потерял свои силы?',
            cells: []
        },
        {
            id: 'word15',
            ...
            length: 10,
            answer: 'КРОВОПИЙЦЫ',
            clue: ' В каком аниме был создан новый препарат которого побочные эффекты превращали людей в вампиров?',
            cells: []
        }
    ]
};
