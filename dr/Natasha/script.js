// Crossword data
const crosswordData = {
    width: 15, //ШИРИНА СЕТКИ
    height: 10, //ВЫСОТА СЕТКИ
    words: [ //МАССИВ СЛОВ, МОЖНО ДОБАВИТЬ ПО ШАБЛОНУ
        {
            ...
            startCol: 5, //С КАКОЙ КОЛОНКИ НАЧИНАЕТСЯ СЛОВО
            length: 4, //ДЛИНА СЛОВА
            answer: 'АГНИ', 
            clue: 'Как зовут дворецкого принца Сомы?',
        ...
        },
        {
            ...
            length: 10,
            answer: 'ОНКОЛОГИЕЙ',
            clue: 'Чем болела маленькая девочка, переродившаяся в Руби Хосино? ',
            cells: []
        },
        {
            id: 'word3',
            ...
            length: 10,
            answer: 'ДВЕНАДЦАТИ',
            clue: 'В течение скольких часов Гуан Лу может просматривать события по фотографии?',
            cells: []
        },
        {
            id: 'word4',
            ...
            length: 5,
            answer: 'ПОВАР',
            clue: 'Профессия Николо из Атаки Титанов?',
            cells: []
        },
        {
            id: 'word5',
            ...
            length: 5,
            answer: 'БЕЛКА',
            clue: 'Домашний питомец главной героини Конфликта братьев?',
            cells: []
        },
        {
            id: 'word6',
            ...
            length: 7,
            answer: 'КОСТЮМЫ',
            clue: 'За что в группе отвечает Котори?',
            cells: []
        },
        {
            id: 'word7',
            ...
            length: 10,
            answer: 'БАТТЕРФЛЯЙ',
            clue: 'Каким стилем плавает Рэй Рюгазаки?',
            cells: []
        },
        {
            id: 'word8',
        ...
        },
        {
            ...
            length: 10,
            answer: 'МАЛИНОВОГО',
            clue: 'Какого цвета были волосы главной героини Йона на заре?',
            cells: []
        },
        {
            id: 'word10',
            ...
            length: 10,
            answer: 'КОМПОЗИТОР',
            clue: 'На кого учиться Нанами Харуки в академии Саотомэ?',
            cells: []
        }
    ]
};
